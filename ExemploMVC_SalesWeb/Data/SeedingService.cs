...
using ExemploMVC_SalesWeb.Models.Enums;

namespace ExemploMVC_SalesWeb.Data
{
    public class SeedingService
    {
        private ExemploMVC_SalesWebContext _context;

        public SeedingService(ExemploMVC_SalesWebContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(2, "Maria Green", "maria@mail.com", new DateTime(1979, 12, 31), 3500.0, d2);
            Seller s3 = new Seller(3, "Alex Grey", "alex@mail.com", new DateTime(1988, 1, 15), 2200.0, d1);
            Seller s4 = new Seller(4, "Martha Red", "martha@mail.com", new DateTime(1993, 11, 30), 3000.0, d4);
            Seller s5 = new Seller(5, "Donald Blue", "donald@mail.com", new DateTime(2000, 1, 9), 4000.0, d3);
            Seller s6 = new Seller(6, "Alex Pink", "alex@mail.com", new DateTime(1997, 3, 4), 3000.0, d2);
